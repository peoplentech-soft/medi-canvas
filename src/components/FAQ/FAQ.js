        ...
        <section id="faq" className="faq section-bg">
            <div className="container" data-aos="fade-up">
                ...
                <div className="section-title">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio facere pariatur, doloribus accusantium hic, veritatis nostrum rem reiciendis commodi quos quasi eum dolor dignissimos officiis? Voluptate, maxime rem ea esse doloremque labore quae tenetur perferendis?</p>
                </div>

                <ul className="faq-list shadow">
                    <li>
                        <div data-bs-toggle="collapse" className="collapsed question" href="#faq1">Non consectetur a erat nam at lectus urna duis? <i className="bi bi-chevron-down icon-show"></i><i className="bi bi-chevron-up icon-close"></i>
                        </div>
                        <div id="faq1" className="collapse" data-bs-parent=".faq-list">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed sequi fuga alias facilis aliquid, aperiam perspiciatis culpa iusto similique vel.</p>
                        </div>
                    </li>
